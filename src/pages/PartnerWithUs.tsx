...
const PartnerWithUs = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Partner With Us | EBL Masterclass 8.0 – JCIN UNIBEN</title>
        <link rel="canonical" href="https://ebl.jcinuniben.com/PartnerWithUs" />
        <meta
          name="description"
          content="Partner with EBL Masterclass by JCIN UNIBEN—sponsorships, collaborations, and brand visibility for employability, business, and leadership programs."
        />
        <meta property="og:url" content="https://ebl.jcinuniben.com/PartnerWithUs" />
        <meta property="og:title" content="Partner With Us | EBL Masterclass 8.0" />
