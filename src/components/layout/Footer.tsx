          ...
          >
            ...
            >
              {[
                {
                  icon: 'LinkedIn',
                  url: 'https://www.linkedin.com/company/jcin-uniben/',
                  svg: (
                    <path
                ...
                {
                  icon: 'Instagram',
                  url: 'https://www.instagram.com/unibenjaycees',
                  svg: (
                    <path
                ...
                {
                  icon: 'Facebook',
                  url: 'https://www.facebook.com/Unibenjaycees',
                  svg: (
                    <path
