  ...
  return (
    <>
      <Helmet>
        ...
        {/* Canonical */}
        <link rel="canonical" href="https://ebl.jcinuniben.com/OurStory" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://ebl.jcinuniben.com/OurStory" />
        <meta
          property="og:title"
        ...
        <meta
          property="og:image"
          content="https://ebl.jcinuniben.com/ebllogo.webp"
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@graph": [
              {
                "@type": "Organization",
                "@id": "https://ebl.jcinuniben.com/#organization",
                name: "EBL Masterclass",
                alternateName: "Employability, Business and Leadership Masterclass",
                url: "https://ebl.jcinuniben.com",
                logo: {
                  "@type": "ImageObject",
                  url: "https://ebl.jcinuniben.com/ebllogo.webp",
                  width: 600,
                  height: 200,
                },
                description:
              ...
              {
                "@type": "WebPage",
                "@id": "https://ebl.jcinuniben.com/OurStory#webpage",
                url: "https://ebl.jcinuniben.com/OurStory",
              ...
              {
                "@type": "BreadcrumbList",
                "@id": "https://ebl.jcinuniben.com/OurStory#breadcrumb",
                itemListElement: [
                  {
                    "@type": "ListItem",
                    position: 1,
                    name: "Home",
                    item: "https://ebl.jcinuniben.com",
                  },
                  {
                    "@type": "ListItem",
                    position: 2,
                    name: "Our Story",
                    item: "https://ebl.jcinuniben.com/OurStory",
                  },
                ],
              },
              {
            ...
            <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 2rem' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }} className="story-grid">
                ...
                <div style={{ background: 'rgba(0, 168, 232, 0.12)', backdropFilter: 'blur(20px)', border: '2px solid rgba(0, 168, 232, 0.3)', borderRadius: '1.5rem', padding: 'clamp(2rem, 4vw, 3rem)', boxShadow: '0 20px 60px rgba(0, 168, 232, 0.2)' }}>
                  <OptimizedImage
                    src={ebl13}
                    alt="EBL Masterclass impact and event statistics"
                    sizes="(max-width: 768px) 100vw, min(900px, 50vw)"
                    style={{
                      width: '100%',
                      height: 'auto',
                      objectFit: 'cover',
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2.5rem' }} className="testimonials-grid">
                {[
                  ...
                  >
                    <OptimizedImage
                      src={item.image}
                      alt={`Portrait of ${item.name.trim()}`}
                      sizes="80px"
                      width={80}
                      height={80}
                      style={{
